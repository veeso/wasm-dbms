...
[![license-mit](https://img.shields.io/crates/l/wasi-dbms-memory.svg)](https://opensource.org/licenses/MIT)
[![repo-stars](https://img.shields.io/github/stars/veeso/wasm-dbms?style=flat)](https://github.com/veeso/wasm-dbms/stargazers)
[![downloads](https://img.shields.io/crates/d/wasi-dbms-memory.svg)](https://crates.io/crates/wasi-dbms-memory)
[![latest-version](https://img.shields.io/crates/v/wasi-dbms-memory.svg)](https://crates.io/crates/wasi-dbms-memory)
