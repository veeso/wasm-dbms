...
[![license-mit](https://img.shields.io/crates/l/wasm-dbms-memory.svg)](https://opensource.org/licenses/MIT)
[![repo-stars](https://img.shields.io/github/stars/veeso/wasm-dbms?style=flat)](https://github.com/veeso/wasm-dbms/stargazers)
[![downloads](https://img.shields.io/crates/d/wasm-dbms-memory.svg)](https://crates.io/crates/wasm-dbms-memory)
[![latest-version](https://img.shields.io/crates/v/wasm-dbms-memory.svg)](https://crates.io/crates/wasm-dbms-memory)
