...
async fn test_should_insert_and_query_project_with_custom_type(env: PocketIcTestEnv) {
...
#[pocket_ic_tests_macro::test]
async fn test_should_filter_project_by_custom_type(env: PocketIcTestEnv) {
    let client = IcDbmsPocketIcClient::new(env.dbms_canister(), env.admin(), &env.pic);
...
#[pocket_ic_tests_macro::test]
async fn test_should_update_project_custom_type_field(env: PocketIcTestEnv) {
    let client = IcDbmsPocketIcClient::new(env.dbms_canister(), env.admin(), &env.pic);
